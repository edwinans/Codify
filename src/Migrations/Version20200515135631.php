 ...
 */
final class Version20200515135631 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE resolution (id INT AUTO_INCREMENT NOT NULL, exercice_id INT DEFAULT NULL, user_id INT DEFAULT NULL, tentatives INT DEFAULT NULL, resolved_at DATETIME DEFAULT NULL, INDEX IDX_FDD30F8A89D40298 (exercice_id), INDEX IDX_FDD30F8AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
